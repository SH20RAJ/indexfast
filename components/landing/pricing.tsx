...
export function Pricing() {
  return (
    <section id="pricing" className="w-full py-12 md:py-24 lg:py-32 bg-white relative">
        <div className="absolute top-10 left-10 hidden lg:block opacity-20 rotate-12 pointer-events-none">
            <span className="font-handwritten text-9xl">?</span>
        </div>
        <div className="absolute bottom-10 right-10 hidden lg:block opacity-20 -rotate-12 pointer-events-none">
            <span className="font-handwritten text-9xl">$</span>
        </div>
         <CreativePricing 
