    ...
    <section id="features" className="w-full py-12 md:py-24 lg:py-32 bg-amber-50">
      <div className="container px-4 md:px-6">
        <div className="text-center mb-16">
            <h2 className="font-handwritten text-4xl md:text-5xl font-bold mb-4">Why IndexFast?</h2>
            <p className="font-handwritten text-xl text-zinc-600">Three simple reasons to switch.</p>
        </div>
        <div className="grid gap-8 md:gap-12 md:grid-cols-3">
            <CreativeCard rotate="left" className="h-full">
                <div className="space-y-4">
                    ...
                    <h3 className="font-handwritten text-2xl font-bold flex items-center gap-2">
                        <CheckCircle2 className="w-6 h-6 text-green-500" />
                        Google Search Console
                    </h3>
                    <p className="font-handwritten text-lg text-zinc-600">
